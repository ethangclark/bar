...
export const MessageComposer = storeObserver<MessageComposerProps>(
    ...
    return (
      ...
      >
        ...
        <div className="w-full text-center text-xs text-gray-400">
          ...
          know if you're done with the topic, or need help. Email questions and
          issues to hello@summited.ai
        </div>
      </div>
    );
  },
